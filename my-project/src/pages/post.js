...
const post = () => {
  return (
    ...
    <form className="flex flex-col max-w-4xl p-4 sm:ml-64 h-screen">
    <h1 className="">Create your Post</h1>
        ...
        <div className="flex flex-col items-center justify-center max-w-1/2 ">
            ...
            <textarea className="w-full bg-slate-100 h-1/3 border-none block resize-none m-4 rounded-xl" placeholder=" Description"></textarea>
            <button className="rounded-full w-1/5 text-xl text-white p-3 bg-blue-600 hover:bg-sky-600 ">Create</button>
